  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        {/* Hero section */}
        <section className="relative bg-gradient-to-b from-emerald-50 to-white py-24">
          <div className="absolute top-20 left-20 w-40 h-40 bg-pink-300 rounded-full opacity-10 blur-3xl"></div>
          <div className="absolute bottom-10 right-10 w-60 h-60 bg-emerald-300 rounded-full opacity-10 blur-3xl"></div>
          
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center max-w-3xl mx-auto">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                Book Your Road Test <span className="bg-gradient-to-r from-emerald-600 to-teal-500 bg-clip-text text-transparent">Car & Instructor</span>
              </h1>
