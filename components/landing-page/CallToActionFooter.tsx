...
export default function CallToActionFooter() {
  return (
    <section className="py-20 bg-gradient-to-r from-gray-800 to-gray-900 text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-emerald-500/10 rounded-full -translate-y-1/2 translate-x-1/3 blur-3xl"></div>
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-emerald-500/5 rounded-full translate-y-1/2 -translate-x-1/4 blur-3xl"></div>
      
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row md:items-center justify-between">
          <div className="text-center md:text-left mb-10 md:mb-0 md:max-w-xl">
            <span className="inline-block px-3 py-1 bg-emerald-900/30 text-emerald-300 rounded-full text-sm font-medium mb-4">
              Need Assistance?
            </span>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a 
              href="#search" 
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold rounded-xl hover:from-emerald-600 hover:to-teal-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
