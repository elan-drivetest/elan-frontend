...
export default function SearchForm({
  ...
  return (
    <div className={`w-full rounded-2xl overflow-hidden shadow-xl border border-gray-200/50 bg-white backdrop-blur-sm ${className}`}>
      <div className="bg-gradient-to-r from-brand-500 to-brand-600 text-white px-8 py-6">
        <h2 className="font-bold text-2xl">Find Your Perfect Driving Test Package</h2>
        <p className="mt-2 text-brand-50">Book a car and instructor for your road test across Canada</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="p-8 space-y-8">
        ...
        <div className="pt-4">
          <button
            type="submit"
            className="w-full py-4 px-6 bg-gradient-to-r from-brand-500 to-brand-600 hover:from-brand-600 hover:to-brand-700 text-white font-bold rounded-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 shadow-lg hover:shadow-xl disabled:opacity-70 disabled:cursor-not-allowed transform hover:-translate-y-1"
      ...
      {formData.meetAtCentre && selectedCenter && (
        <div className="bg-gradient-to-r from-blue-50 to-brand-50 p-6 border-t border-blue-100">
          <div className="flex">
            <div className="flex-shrink-0">
              <svg className="h-8 w-8 text-brand-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div className="mt-2 text-brand-700">
                ...
                <ul className="mt-3 space-y-2 pl-5">
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-brand-500 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="mt-4">
                  <button 
                    ...
                    className="bg-brand-100 text-brand-800 px-4 py-2 rounded-lg text-sm font-medium hover:bg-brand-200 transition-colors"
                  >
